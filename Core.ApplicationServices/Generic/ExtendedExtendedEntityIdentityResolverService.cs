...
{
    public class ExtendedEntityIdentityResolverService : IExtendedEntityIdentityResolverService
    {
        private readonly IEntityIdentityResolver _entityIdentityResolver;

        public ExtendedEntityIdentityResolverService(IEntityIdentityResolver entityIdentityResolver)
        {
