...
namespace Core.ApplicationServices.Model.Contracts.Write
{
    public class ItContractGeneralDataModificationParameters
    {
        ...
        public OptionalValueChange<string> CriticalityTypeId { get; set; } = OptionalValueChange<string>.None;
        public OptionalValueChange<Guid?> CriticalityTypeUuid { get; set; } = OptionalValueChange<Guid?>.None;
    }
}
