...
namespace Core.ApplicationServices.ItSystemUsageMigration
{
    ...
    {
        Result<ResultStatus, IEnumerable<ItSystem>> GetUnusedItSystemsByOrganization(int organizationId, string nameContent, int numberOfItSystems, bool getPublicFromOtherOrganizations);
