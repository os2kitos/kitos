...
namespace Tests.Integration.Presentation.Web.Tools.External
{
    public static class ItSystemV2Helper
    {
        ...
        public static async Task<IEnumerable<RegistrationHierarchyNodeWithDisabledStatusResponseDTO>> GetHierarchyAsync(string token, Guid systemUuid)
        {
            ...
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            return await response.ReadResponseBodyAsAsync<IEnumerable<RegistrationHierarchyNodeWithDisabledStatusResponseDTO>>();
        }
