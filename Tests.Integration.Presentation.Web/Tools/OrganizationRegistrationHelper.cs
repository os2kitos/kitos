...
namespace Tests.Integration.Presentation.Web.Tools
{
    ...
    {
        public static async Task<OrganizationRegistrationDTO> GetRegistrationsAsync(Guid organizationUuid, Guid unitUuid, Cookie optionalLogin = null)
        {
        ...
        public static async Task DeleteSelectedRegistrationsAsync(Guid organizationUuid, Guid unitUuid, ChangeOrganizationRegistrationRequestDTO body, Cookie optionalLogin = null)
        {
            var cookie = optionalLogin ?? await HttpApi.GetCookieAsync(OrganizationRole.GlobalAdmin);
            var orgUnitUrl = TestEnvironment.CreateUrl($"api/v1/organizations/{organizationUuid}/organization-units/{unitUuid}/registrations");
        ...
        public static async Task TransferRegistrationsAsync(Guid organizationUuid, Guid unitUuid, Guid targetUnitUuid, ChangeOrganizationRegistrationRequestDTO body, Cookie optionalLogin = null)
        {
            var cookie = optionalLogin ?? await HttpApi.GetCookieAsync(OrganizationRole.GlobalAdmin);
            var orgUnitUrl = TestEnvironment.CreateUrl($"api/v1/organizations/{organizationUuid}/organization-units/{unitUuid}/registrations/{targetUnitUuid}");
