...
{
    public class ItProject : HasRightsEntity<ItProject, ItProjectRight, ItProjectRole>,IHasReferences, IHasAccessModifier, IHierarchy<ItProject>, IContextAware, IProjectModule, IHasOrganization, IHasName, IEntityWithExternalReferences, IAggregateRoot
    {
        public ItProject()
        {
