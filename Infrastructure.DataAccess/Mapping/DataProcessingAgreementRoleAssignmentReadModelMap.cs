...
{
    public class DataProcessingAgreementRoleAssignmentReadModelMap : EntityTypeConfiguration<DataProcessingAgreementRoleAssignmentReadModel>
    {
        public DataProcessingAgreementRoleAssignmentReadModelMap()
        {
            HasKey(x => x.Id);
