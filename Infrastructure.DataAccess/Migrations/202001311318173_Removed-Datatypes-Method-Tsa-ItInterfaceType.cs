namespace Infrastructure.DataAccess.Migrations
{
    ...
    public partial class RemovedDatatypesMethodTsaItInterfaceType : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.ItInterface", "InterfaceTypeId");
            DropColumn("dbo.ItInterface", "TsaId");
            DropColumn("dbo.ItInterface", "MethodId");
        ...
        public override void Down()
        {
            ...
            AddColumn("dbo.ItInterface", "MethodId", c => c.Int());
            AddColumn("dbo.ItInterface", "TsaId", c => c.Int());
            AddColumn("dbo.ItInterface", "InterfaceTypeId", c => c.Int());
