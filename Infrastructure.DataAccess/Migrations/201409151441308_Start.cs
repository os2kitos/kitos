    ...
    public partial class Start : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Tsas", t => t.Tsa_Id)
                .ForeignKey("dbo.User", t => t.LastChangedByUserId, cascadeDelete: true)
                .ForeignKey("dbo.User", t => t.ObjectOwnerId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        infUseId = c.Int(nullable: false),
                        infUsageId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                ...
                .ForeignKey("dbo.ItInterfaceUses", t => new { t.infUseId, t.infUsageId }, cascadeDelete: true)
                ...
                .Index(t => new { t.infUseId, t.infUsageId });
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.InfUsage", t => t.InterfaceUsageId, cascadeDelete: true)
                .ForeignKey("dbo.User", t => t.LastChangedByUserId, cascadeDelete: true)
                .ForeignKey("dbo.User", t => t.ObjectOwnerId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Exhibit", t => t.ExhibitedById)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Exhibit", "Id", "dbo.ItSystem");
            DropForeignKey("dbo.ItInterfaceUses", "ItSystemId", "dbo.ItSystem");
            DropForeignKey("dbo.InfUsage", "ObjectOwnerId", "dbo.User");
            DropForeignKey("dbo.InfUsage", "LastChangedByUserId", "dbo.User");
            DropForeignKey("dbo.InfUsage", "ItSystemUsageId", "dbo.ItSystemUsage");
            DropForeignKey("dbo.InfUsage", new[] { "infUseId", "infUsageId" }, "dbo.ItInterfaceUses");
            DropForeignKey("dbo.InfUsage", "ItContractId", "dbo.ItContract");
            DropForeignKey("dbo.InfUsage", "InfrastructureId", "dbo.ItSystem");
            DropForeignKey("dbo.DataRowUsage", "ObjectOwnerId", "dbo.User");
            DropForeignKey("dbo.DataRowUsage", "LastChangedByUserId", "dbo.User");
            DropForeignKey("dbo.DataRowUsage", "InterfaceUsageId", "dbo.InfUsage");
            ...
            DropForeignKey("dbo.ItSystem", "Tsa_Id", "dbo.Tsas");
            ...
            DropForeignKey("dbo.InfUsage", "ItInterface_Id", "dbo.ItInterface");
            ...
            DropForeignKey("dbo.ItInterface", "ExhibitedById", "dbo.Exhibit");
            DropForeignKey("dbo.Exhibit", "ObjectOwnerId", "dbo.User");
            DropForeignKey("dbo.Exhibit", "LastChangedByUserId", "dbo.User");
            DropForeignKey("dbo.ItInterfaceExhibitUsage", "ObjectOwnerId", "dbo.User");
            DropForeignKey("dbo.ItInterfaceExhibitUsage", "LastChangedByUserId", "dbo.User");
            ...
            DropIndex("dbo.ItInterfaceExhibitUsage", new[] { "LastChangedByUserId" });
            DropIndex("dbo.ItInterfaceExhibitUsage", new[] { "ObjectOwnerId" });
            ...
            DropIndex("dbo.ItInterface", new[] { "ExhibitedById" });
            ...
            DropIndex("dbo.DataRowUsage", new[] { "LastChangedByUserId" });
            DropIndex("dbo.DataRowUsage", new[] { "ObjectOwnerId" });
            ...
            DropIndex("dbo.InfUsage", new[] { "infUseId", "infUsageId" });
            DropIndex("dbo.InfUsage", new[] { "ItInterface_Id" });
            DropIndex("dbo.InfUsage", new[] { "LastChangedByUserId" });
            DropIndex("dbo.InfUsage", new[] { "ObjectOwnerId" });
