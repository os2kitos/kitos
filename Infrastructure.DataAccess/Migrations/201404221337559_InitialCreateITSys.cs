namespace Infrastructure.DataAccess.Migrations
{
    ...
    public partial class InitialCreateITSys : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        UsageType_Id = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ItSystem", "UsageType_Id", "dbo.UsageTypes");
            ...
            DropForeignKey("dbo.ItSystemItSystem1", "ItSystem_Id1", "dbo.ItSystem");
            DropForeignKey("dbo.ItSystemItSystem1", "ItSystem_Id", "dbo.ItSystem");
            ...
            DropIndex("dbo.ItSystemItSystem1", new[] { "ItSystem_Id1" });
            DropIndex("dbo.ItSystemItSystem1", new[] { "ItSystem_Id" });
            ...
            DropIndex("dbo.ItSystem", new[] { "UsageType_Id" });
            ...
            DropTable("dbo.ItSystemItSystem1");
