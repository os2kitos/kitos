    ...
    public partial class AddItSystemUsageOverviewReadModel : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        ItSystemBusinessTypeName = c.String(maxLength: 100),
                        ItSystemBelongsToName = c.String(maxLength: 100),
                    })
                .PrimaryKey(t => t.Id)
                ...
                .Index(t => t.ItSystemBelongsToName, name: "ItSystemUsageOverviewReadModel_Index_ItSystemBelongsToName");
            ...
            AlterColumn("dbo.AgreementElementTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.GoalTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.OrganizationUnitRoles", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ItProjectTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ItProjectRoles", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.DataTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.InterfaceTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.RelationFrequencyTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ItContractTemplateTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ItContractTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.HandoverTrialTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.OptionExtendTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.PaymentFreqencyTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.PaymentModelTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.PriceRegulationTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ProcurementStrategyTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.PurchaseFormTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ItContractRoles", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.TerminationDeadlineTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.DataProcessingBasisForTransferOptions", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.DataProcessingDataResponsibleOptions", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.DataProcessingCountryOptions", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.DataProcessingOversightOptions", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.DataProcessingRegistrationRoles", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ItSystemRoles", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.ArchiveTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.SensitiveDataTypes", "Name", c => c.String(nullable: false, maxLength: 100));
            AlterColumn("dbo.BusinessTypes", "Name", c => c.String(nullable: false, maxLength: 100));
