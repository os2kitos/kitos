namespace Infrastructure.DataAccess.Migrations
{
    ...
    public partial class Add_DPA_Option_Types : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.DataProcessingTransferReasonOptions",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false),
            ...
            CreateTable(
                "dbo.LocalDataProcessingTransferReasonOptions",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Description = c.String(),
            ...
            AddColumn("dbo.DataProcessingAgreements", "DataProcessingTransferReasonOption_Id", c => c.Int());
            ...
            CreateIndex("dbo.DataProcessingAgreements", "DataProcessingTransferReasonOption_Id");
            ...
            AddForeignKey("dbo.DataProcessingAgreements", "DataProcessingTransferReasonOption_Id", "dbo.DataProcessingTransferReasonOptions", "Id");
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.LocalDataProcessingTransferReasonOptions", "OrganizationId", "dbo.Organization");
            DropForeignKey("dbo.LocalDataProcessingTransferReasonOptions", "ObjectOwnerId", "dbo.User");
            DropForeignKey("dbo.LocalDataProcessingTransferReasonOptions", "LastChangedByUserId", "dbo.User");
            ...
            DropForeignKey("dbo.DataProcessingAgreements", "DataProcessingTransferReasonOption_Id", "dbo.DataProcessingTransferReasonOptions");
            DropForeignKey("dbo.DataProcessingTransferReasonOptions", "ObjectOwnerId", "dbo.User");
            DropForeignKey("dbo.DataProcessingTransferReasonOptions", "LastChangedByUserId", "dbo.User");
            ...
            DropIndex("dbo.LocalDataProcessingTransferReasonOptions", new[] { "LastChangedByUserId" });
            DropIndex("dbo.LocalDataProcessingTransferReasonOptions", new[] { "ObjectOwnerId" });
            DropIndex("dbo.LocalDataProcessingTransferReasonOptions", new[] { "OrganizationId" });
            ...
            DropIndex("dbo.DataProcessingTransferReasonOptions", new[] { "LastChangedByUserId" });
            DropIndex("dbo.DataProcessingTransferReasonOptions", new[] { "ObjectOwnerId" });
            ...
            DropIndex("dbo.DataProcessingAgreements", new[] { "DataProcessingTransferReasonOption_Id" });
            ...
            DropColumn("dbo.DataProcessingAgreements", "DataProcessingTransferReasonOption_Id");
            ...
            DropTable("dbo.LocalDataProcessingTransferReasonOptions");
            ...
            DropTable("dbo.DataProcessingTransferReasonOptions");
