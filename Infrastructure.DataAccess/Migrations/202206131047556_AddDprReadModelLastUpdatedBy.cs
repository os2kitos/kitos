namespace Infrastructure.DataAccess.Migrations
{
    ...
    public partial class AddDprReadModelLastUpdatedBy : DbMigration
    {
        public override void Up()
        {
            ...
            CreateIndex("dbo.DataProcessingRegistrationReadModels", "LastChangedById", name: "DataProcessingRegistrationReadModel_Index_LastChangedById");
            CreateIndex("dbo.DataProcessingRegistrationReadModels", "LastChangedByName", name: "DataProcessingRegistrationReadModel_Index_LastChangedByName");
            CreateIndex("dbo.DataProcessingRegistrationReadModels", "LastChangedAt", name: "DataProcessingRegistrationReadModel_Index_LastChangedAt");
        }
        
        public override void Down()
        {
            DropIndex("dbo.DataProcessingRegistrationReadModels", "DataProcessingRegistrationReadModel_Index_LastChangedAt");
            DropIndex("dbo.DataProcessingRegistrationReadModels", "DataProcessingRegistrationReadModel_Index_LastChangedByName");
