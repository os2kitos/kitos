        ...
        private activate() {
            var mainGridOptions: IKendoGridOptions<IGridModel> = {
                ...
                detailTemplate: (dataItem) => `<uib-tabset active="0">
                    ...
                    <uib-tab index="4" heading="Databehandlerregisteringer roller"><user-dpr-roles user-id="${dataItem.Id}" current-organization-id="${this.user.currentOrganizationId}"></user-dpr-roles></uib-tab>
                </uib-tabset>`,
