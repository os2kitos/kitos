    ...
    app.controller("system.SystemInterfaceMainCtrl",
        [
            ...
            ($scope, $http, $state, notify, itInterface, user, hasWriteAccess, interfaces, dataTypes, dataRows, select2LoadingService, _) => {
                ...
                $scope.organizationSelectOptions = select2LoadingService.loadSelect2(Kitos.Constants.Organization.BaseApiPath, true, Kitos.Helpers.Select2ApiQueryHelper.getOrganizationQueryParams(true, 25), false);
