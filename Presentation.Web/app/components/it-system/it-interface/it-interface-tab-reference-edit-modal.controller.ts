(function (ng, app) {
    app.config(['$stateProvider', function ($stateProvider) {
        $stateProvider.state('it-system.interface-edit.references.edit', {
            ...
            onEnter: ['$state', '$stateParams', '$uibModal','$http',
                function ($state, $stateParams, $modal, $http) {
                    $modal.open({
                        ...
                        controller: "interface.referenceEditModalCtrl",
                       resolve: {
    ...
    app.controller("interface.referenceEditModalCtrl",
