        ...
        $stateProvider.state('it-system', {
            ...
            controller: ['$rootScope', '$http', '$state', 'notify', 'user', '$scope', function ($rootScope, $http, $state, notify, user, $scope) {
                ...
                $rootScope.page.subnav = [
                    ...
                    { state: Kitos.Constants.ApplicationStateId.SystemCatalog, substate: 'it-system.edit', text: 'IT Systemkatalog' },
                    { state: Kitos.Constants.ApplicationStateId.InterfaceCatalog, substate: 'it-system.interface-edit.main', text: 'Snitfladekatalog' }
                ];
