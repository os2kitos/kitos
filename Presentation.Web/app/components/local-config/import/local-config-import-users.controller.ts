(function (ng, app) {
    ...
    app.controller('local-config.import.ImportUserCtrl', [
        ...
        function ($rootScope, $scope, $http, notify, user) {
            $scope.url = 'api/local-admin/excel/users-by-id?organizationId=' + user.currentOrganizationId + '&exportUsers';
            $scope.title = 'brugere';
            ...
            $scope.submit = function () {
                ...
                $http.post('/api/local-admin/excel/users-by-id?organizationId=' + user.currentOrganizationId + '&importUsers', formData, {
