(function (ng, app) {
    ...
    app.controller('local-config.import.ImportOrgCtrl', [
        ...
        function ($scope, $http, notify, user) {
            $scope.url = 'api/local-admin/excel/units-by-id?organizationId=' + user.currentOrganizationId + '&exportOrgUnits';
            ...
            $scope.submit = function () {
                ...
                $http.post('/api/local-admin/excel/units-by-id?organizationId=' + user.currentOrganizationId + '&importOrgUnits', formData, {
