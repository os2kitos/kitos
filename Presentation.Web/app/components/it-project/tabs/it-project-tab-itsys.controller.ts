            ...
            $stateProvider.state("it-project.edit.itsys", {
                ...
                resolve: {
                    ...
                    systemSelectionOptions: [
                        "hasWriteAccess", "project", "$http","usages",
                        (hasWriteAccess: boolean, project, $http, usages) =>
                            <Shared.GenericTabs.SelectItSystems.IGenericItSystemsSelectionConfiguration>
                            {
                                ...
                                searchUrl: `api/itSystemUsage?organizationId=${project.organizationId}`,
                                searchUrlQueryComponent: "q",
                                searchUrlPageSizeComponent: "take=25",
                                assignedSystems: usages || [],
