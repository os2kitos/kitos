            ...
            var mainGridOptions: IKendoGridOptions<IItProjectInactiveOverview> = {
                ...
                dataSource: {
                    ...
                    transport: {
                        read: {
                            url: (options) => {
                                var urlParameters = `?$expand=ItProjectStatuses,Parent,ItProjectType,Rights($expand=User,Role),ResponsibleUsage($expand=OrganizationUnit),GoalStatus,EconomyYears,Reference,ItProjectStatusUpdates($orderby=Created desc;$top=1)`;
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: dataItem => {
                            ...
                            return this.moment(dataItem.CurrentPhaseObj.StartDate).format(Constants.DateFormat.DanishDateFormat);
                        },
                        excelTemplate: dataItem => {
                            if (!dataItem.CurrentPhaseObj || !dataItem.CurrentPhaseObj.StartDate) {
                                return "";
                    ...
                    },
                    {
                        ...
                        template: dataItem => {
                            ...
                            return this.moment(dataItem.CurrentPhaseObj.EndDate).format(Constants.DateFormat.DanishDateFormat);
                        },
                        excelTemplate: dataItem => {
                            if (!dataItem.CurrentPhaseObj || !dataItem.CurrentPhaseObj.EndDate) {
                                return "";
