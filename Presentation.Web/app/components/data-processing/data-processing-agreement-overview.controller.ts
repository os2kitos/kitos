module Kitos.DataProcessing.Agreement.Overview {
    ...
    import IKendoGridLauncherFactory = Utility.KendoGrid.IKendoGridLauncherFactory;
    import IGridViewAccess = Utility.KendoGrid.IGridViewAccess;


    export interface IOverviewController extends  IGridViewAccess<IDataProcessingAgreement> {
    }
    ...
    export class OverviewController implements IOverviewController {
        ...
        public mainGrid: IKendoGrid<IDataProcessingAgreement>;
        public mainGridOptions: IKendoGridOptions<IDataProcessingAgreement>;
        ...
        constructor(
            ...
            kendoGridLauncherFactory: IKendoGridLauncherFactory) {
            this.$rootScope.page.title = "Databehandleraftaler - Overblik";

            kendoGridLauncherFactory
                .create()
                .withScope($scope)
                .withAccessRights(userAccessRights)
                .withUser(user)
