        ...
        '$stateProvider', function ($stateProvider) {
            $stateProvider.state('it-contract.edit.main', {
                ...
                resolve: {
                    ...
                    contractTypes: [
                        '$http', function ($http) {
                            return $http.get('odata/LocalItContractTypes?$filter=IsLocallyAvailable eq true or IsObligatory eq true').then(function (result) {
                    ...
                    contractTemplates: [
                        '$http', function ($http) {
                            return $http.get('odata/LocalItContractTemplateTypes?$filter=IsLocallyAvailable eq true or IsObligatory eq true').then(function (result) {
                                return result.data.value;
                            });
                        }
                    ],
                    purchaseForms: [
                        '$http', function ($http) {
                            return $http.get('odata/LocalPurchaseFormTypes?$filter=IsLocallyAvailable eq true or IsObligatory eq true').then(function (result) {
                                return result.data.value;
                            });
                        }
                    ],
                    procurementStrategies: [
                        '$http', function ($http) {
                            return $http.get('odata/LocalProcurementStrategyTypes?$filter=IsLocallyAvailable eq true or IsObligatory eq true').then(function (result) {
                                return result.data.value;
                            });
                        }
                    ],
                    ...
                    agreementElements: [
                        '$http', function ($http) {
                            return $http.get('odata/LocalAgreementElementTypes?$filter=IsLocallyAvailable eq true or IsObligatory eq true').then(function (result) {
                                return result.data.value;
                            });
                        }
                    ],
