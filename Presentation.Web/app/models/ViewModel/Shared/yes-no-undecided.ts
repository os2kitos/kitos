    ...
    export class YesNoUndecidedOptions {
        ...
        constructor() {
            ...
            this.options = [
                ...
                <Select2OptionViewModel<Models.Api.Shared.YesNoUndecidedOption>>{ id: Models.Api.Shared.YesNoUndecidedOption.Yes as number, text: "Ja", optionalObjectContext: Models.Api.Shared.YesNoUndecidedOption.Yes },
                <Select2OptionViewModel<Models.Api.Shared.YesNoUndecidedOption>>{ id: Models.Api.Shared.YesNoUndecidedOption.No as number, text: "Nej", optionalObjectContext: Models.Api.Shared.YesNoUndecidedOption.No },
            ];
        }
    }
}