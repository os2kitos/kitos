module Kitos.Services {
    ...
    export interface ISelect2LoadingService {
        ...
        select2LocalDataFormattedIndentation(dataFn: () => Models.ViewModel.Generic.Select2OptionViewModelWithIndentation<any>[], formatResults: (input) => string, allowClear?: boolean);
    }
    ...
    export class Select2LoadingService implements ISelect2LoadingService {
        ...
        select2LocalDataFormattedIndentation(dataFn: () => Models.ViewModel.Generic.Select2OptionViewModelWithIndentation<any>[], formatResults: (input) => string, allowClear= true) {
            return {
                data: () => ({ "results": dataFn() }),
                allowClear: allowClear,
                formatResult: formatResults
