...
import PageObject = require("../../../../app/components/it-system/usage/tabs/it-system-usage-tab-kle.po");

describe("system usage tab kle", () => {
    ...
    describe("with write access", () => {
        ...
        it("should check all tasks on page on confirmed select all click", () => {
            ...
            pageObject.taskRepeater.each(elem => {
                ...
                checkbox.getAttribute("id")
                    .then(id =>
                        expect(mock.requestsMade()).toMatchInRequests({ method: "POST", url: `api/itSystemUsage/1?(.[^ ])*taskId=${id}` }));
        ...
        it("should not check all tasks on page on dismissed select all click", () => {
            ...
            pageObject.taskRepeater.each(elem => {
                ...
                checkbox.getAttribute("id")
                    .then(id =>
                        expect(mock.requestsMade()).not.toMatchInRequests({ method: "POST", url: `api/itSystemUsage/1?(.[^ ])*taskId=${id}` }));
        ...
        it("should uncheck all tasks on page on confirmed deselect all click", () => {
            ...
            pageObject.taskRepeater.each(elem => {
                ...
                checkbox.getAttribute("id")
                    .then(id =>
                        expect(mock.requestsMade()).toMatchInRequests({ method: "DELETE", url: `api/itSystemUsage/1?(.[^ ])*taskId=${id}` }));
        ...
        it("should not uncheck all tasks on page on dismissed deselect all click", () => {
            ...
            pageObject.taskRepeater.each(elem => {
                ...
                checkbox.getAttribute("id")
                    .then(id =>
                        expect(mock.requestsMade()).not.toMatchInRequests({ method: "DELETE", url: `api/itSystemUsage/1?(.[^ ])*taskId=${id}` }));
