...
var PageObject = require("../../../../app/components/it-system/edit/tabs/it-system-edit-tab-kle.po");
describe("system edit tab kle", function () {
    var mockHelper;
    var browserHelper;
    var pageObject;
    ...
    describe("with write access", function () {
        ...
        it("should check all tasks on page on confirmed select all click", function () {
            ...
            pageObject.taskRepeater.each(function (elem) {
                ...
                checkbox.getAttribute("id")
                    .then(function (id) {
                    return expect(mock.requestsMade()).toMatchInRequests({ method: "POST", url: "api/itSystem/1?(.[^ ])*taskId=" + id });
                });
        ...
        it("should not check all tasks on page on dismissed select all click", function () {
            ...
            pageObject.taskRepeater.each(function (elem) {
                ...
                checkbox.getAttribute("id")
                    .then(function (id) {
                    return expect(mock.requestsMade()).not.toMatchInRequests({ method: "POST", url: "api/itSystem/1?(.[^ ])*taskId=" + id });
                });
        ...
        it("should uncheck all tasks on page on confirmed deselect all click", function () {
            ...
            pageObject.taskRepeater.each(function (elem) {
                ...
                checkbox.getAttribute("id")
                    .then(function (id) {
                    return expect(mock.requestsMade()).toMatchInRequests({ method: "DELETE", url: "api/itSystem/1?(.[^ ])*taskId=" + id });
                });
                expect(checkbox).not.toBeChecked();
            });
        });
        it("should not uncheck all tasks on page on dismissed deselect all click", function () {
            ...
            pageObject.taskRepeater.each(function (elem) {
                ...
                checkbox.getAttribute("id")
                    .then(function (id) {
                    return expect(mock.requestsMade()).not.toMatchInRequests({ method: "DELETE", url: "api/itSystem/1?(.[^ ])*taskId=" + id });
                });
                expect(checkbox).toBeChecked();
            });
        });
