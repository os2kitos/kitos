...
namespace Presentation.Web.Models.API.V2.Response.DataProcessing
{
    public class DataProcessingRegistrationGeneralDataResponseDTO
    {
        ...
        /// </summary>
        public IEnumerable<ShallowOrganizationResponseDTO> SubDataProcessors { get; set; } //TODO: Change to a more detailed dto with same uuid + name but also with the other data!
