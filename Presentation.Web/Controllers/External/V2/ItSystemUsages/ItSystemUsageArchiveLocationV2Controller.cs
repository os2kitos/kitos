...
{
    [RoutePrefix("api/v2/it-system-usage-archive-locations")]
    public class ItSystemUsageArchiveLocationV2Controller : BaseOptionTypeV2Controller<ItSystemUsage, ArchiveLocation>
    {
        public ItSystemUsageArchiveLocationV2Controller(IOptionsApplicationService<ItSystemUsage, ArchiveLocation> optionService)
            : base(optionService)
        {
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult GetItSystemUsageArchiveLocation(Guid archiveLocationUuid, Guid organizationUuid)
        {
