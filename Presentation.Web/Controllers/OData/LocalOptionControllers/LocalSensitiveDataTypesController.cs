...
{
    [InternalApi]
    [ODataRoutePrefix("LocalSensitiveDataTypes")]
    public class LocalSensitiveDataTypesController : LocalOptionBaseController<LocalSensitiveDataType, ItSystemUsage, SensitiveDataType>
    {
        ...
        [ODataRoute]
        public override IHttpActionResult Post(int organizationId, LocalSensitiveDataType entity) => base.Post(organizationId, entity);

        [ODataRoute]
        public override IHttpActionResult Patch(int organizationId, int key, Delta<LocalSensitiveDataType> delta) => base.Patch(organizationId, key, delta);
