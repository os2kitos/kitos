...
{
    [InternalApi]
    [ODataRoutePrefix("LocalPaymentModelTypes")]
    public class LocalPaymentModelTypesController : LocalOptionBaseController<LocalPaymentModelType, ItContract, PaymentModelType>
    {
        ...
        [ODataRoute]
        public override IHttpActionResult Post(int organizationId, LocalPaymentModelType entity) => base.Post(organizationId, entity);

        [ODataRoute]
        public override IHttpActionResult Patch(int organizationId, int key, Delta<LocalPaymentModelType> delta) => base.Patch(organizationId, key, delta);
