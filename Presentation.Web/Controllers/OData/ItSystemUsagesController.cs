...
namespace Presentation.Web.Controllers.OData
{
    public class ItSystemUsagesController : BaseEntityController<ItSystemUsage>
    {
        ...
        public ItSystemUsagesController(IGenericRepository<ItSystemUsage> repository, IUserService userService, IAuthenticationService authService, IGenericRepository<OrganizationUnit> orgUnitRepository)
            : base(repository)
        {
