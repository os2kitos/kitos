...
namespace Presentation.Web.Controllers.API.V2.External.ItSystems.Mapping
{
    public class ItSystemWriteModelMapper : WriteModelMapperBase, IItSystemWriteModelMapper
    {
        ...
        {
            bool ShouldChange(Expression<Func<IRightsHolderWritableSystemPropertiesRequestDTO, object>> pickProperty) => ClientRequestsChangeTo(pickProperty) || enforceResetOnMissingProperty;
