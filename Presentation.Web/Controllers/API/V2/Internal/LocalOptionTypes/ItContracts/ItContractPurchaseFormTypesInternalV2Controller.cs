...
{
    [RoutePrefix("api/v2/internal/it-contracts/{organizationUuid}/local-option-types/purchase-form-types")]
    public class ItContractLocalPurchaseFormTypesInternalV2Controller : BaseLocalRegularOptionTypesInternalV2Controller<LocalPurchaseFormType, ItContract, PurchaseFormType>
    {
        ...
        public IHttpActionResult GetLocalPurchaseFormTypes([NonEmptyGuid][FromUri] Guid organizationUuid)
        {
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult GetLocalPurchaseFormTypeByOptionId([NonEmptyGuid][FromUri] Guid organizationUuid, [FromUri] Guid optionUuid)
        {
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateLocalResultPurchaseFormType([NonEmptyGuid][FromUri] Guid organizationUuid, LocalOptionCreateRequestDTO dto)
        {
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchLocalPurchaseFormType([NonEmptyGuid][FromUri] Guid organizationUuid,
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult DeleteLocalPurchaseFormType([NonEmptyGuid][FromUri] Guid organizationUuid,
            [FromUri] Guid optionUuid)
        {
