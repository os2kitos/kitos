...
{
    [RoutePrefix("api/v2/internal/it-contracts/{organizationUuid}/local-option-types/termination-deadline-types")]
    public class ItContractLocalTerminationDeadlineTypesInternalV2Controller : BaseLocalRegularOptionTypesInternalV2Controller<LocalTerminationDeadlineType, ItContract, TerminationDeadlineType>
    {
        ...
        public IHttpActionResult GetLocalTerminationDeadlineTypes([NonEmptyGuid][FromUri] Guid organizationUuid)
        {
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult GetLocalTerminationDeadlineTypeByOptionId([NonEmptyGuid][FromUri] Guid organizationUuid, [FromUri] Guid optionUuid)
        {
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateLocalTerminationDeadlineType([NonEmptyGuid][FromUri] Guid organizationUuid, LocalOptionCreateRequestDTO dto)
        {
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchLocalTerminationDeadlineType([NonEmptyGuid][FromUri] Guid organizationUuid,
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult DeleteLocalTerminationDeadlineType([NonEmptyGuid][FromUri] Guid organizationUuid,
            [FromUri] Guid optionUuid)
        {
