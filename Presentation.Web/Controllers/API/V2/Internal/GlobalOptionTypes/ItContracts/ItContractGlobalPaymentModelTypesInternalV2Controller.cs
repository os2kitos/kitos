...
{
    [RoutePrefix("api/v2/internal/it-contract/global-option-types/payment-model-types")]
    ...
    public class ItContractGlobalPaymentModelTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, PaymentModelType>
    {
        ...
        public IHttpActionResult GetGlobalPaymentModelTypes()
        {
            return GetAll();
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateGlobalPaymentModelType(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchGlobalPaymentModelType([NonEmptyGuid][FromUri] Guid optionUuid,
