...
{
    [RoutePrefix("api/v2/internal/it-contract/global-option-types/option-extend-types")]
    ...
    public class ItContractGlobalOptionExtendTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, OptionExtendType>
    {
        ...
        public IHttpActionResult GetGlobalOptionExtendTypes()
        {
            return GetAll();
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateGlobalOptionExtendType(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchGlobalOptionExtendType([NonEmptyGuid][FromUri] Guid optionUuid,
