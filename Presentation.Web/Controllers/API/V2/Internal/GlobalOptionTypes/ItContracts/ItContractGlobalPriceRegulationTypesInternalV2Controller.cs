...
{
    [RoutePrefix("api/v2/internal/it-contract/global-option-types/price-regulation-types")]
    ...
    public class ItContractGlobalPriceRegulationTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItContract, PriceRegulationType>
    {
        ...
        public IHttpActionResult GetGlobalPriceRegulationTypes()
        {
            return GetAll();
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateGlobalPriceRegulationType(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchGlobalPriceRegulationType([NonEmptyGuid][FromUri] Guid optionUuid,
