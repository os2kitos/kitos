...
{
    [RoutePrefix("api/v2/internal/it-systems/global-option-types/data-types")]
    ...
    public class ItSystemGlobalDataTypesInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<DataRow, DataType>
    {
        ...
        public IHttpActionResult GetGlobalDataTypes()
        {
            return GetAll();
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateGlobalDataType(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchGlobalDataType([NonEmptyGuid][FromUri] Guid optionUuid,
