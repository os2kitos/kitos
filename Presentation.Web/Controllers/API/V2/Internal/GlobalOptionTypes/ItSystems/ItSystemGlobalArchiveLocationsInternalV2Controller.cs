...
namespace Presentation.Web.Controllers.API.V2.Internal.GlobalOptionTypes.ItSystems
{
    ...
    public class ItSystemGlobalArchiveLocationsInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<ItSystemUsage, ArchiveLocation>
    {
        public ItSystemGlobalArchiveLocationsInternalV2Controller(IGlobalRegularOptionsService<ArchiveLocation, ItSystemUsage> globalRegularOptionsService, IGlobalOptionTypeResponseMapper responseMapper, IGlobalOptionTypeWriteModelMapper writeModelMapper) : base(globalRegularOptionsService, responseMapper, writeModelMapper)
        {
        }
