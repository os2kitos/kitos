...
{
    [RoutePrefix("api/v2/internal/dpr/global-option-types/data-processing-basis-for-transfer-options")]
    ...
    public class DprGlobalDataProcessingBasisForTransferOptionsInternalV2Controller: BaseGlobalRegularOptionTypesInternalV2Controller<DataProcessingRegistration, DataProcessingBasisForTransferOption>
    {
        ...
        public IHttpActionResult GetGlobalDataProcessingBasisForTransferOptions()
        {
            return GetAll();
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult CreateGlobalDataProcessingBasisForTransferOption(GlobalRegularOptionCreateRequestDTO dto)
        {
            return Create(dto);
        }
        ...
        [SwaggerResponse(HttpStatusCode.Forbidden)]
        [SwaggerResponse(HttpStatusCode.NotFound)]
        public IHttpActionResult PatchGlobalDataProcessingBasisForTransferOption([NonEmptyGuid][FromUri] Guid optionUuid,
