...
{
    [InternalApi]
    [ODataRoutePrefix("LocalCriticalityTypes")]
    public class LocalCriticalityTypesController : LocalOptionBaseController<LocalCriticalityType, ItContract, CriticalityType>
    {
        public LocalCriticalityTypesController(IGenericRepository<LocalCriticalityType> repository, IGenericRepository<CriticalityType> optionsRepository)
