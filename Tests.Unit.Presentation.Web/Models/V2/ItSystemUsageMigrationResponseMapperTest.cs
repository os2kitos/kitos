...
namespace Tests.Unit.Presentation.Web.Models.V2
{
    public class ItSystemUsageMigrationResponseMapperTest : WithAutoFixture
    {
        ...
        public void Can_MapMigration()
        {
            ...
            AssertIdentityNamePairWithDeactivatedStatus(affectedRelation.ToSystemUsage.ItSystem, relationDto.ToSystem);
            AssertIdentityNamePairWithDeactivatedStatus(affectedRelation.FromSystemUsage.ItSystem, relationDto.FromSystem);
